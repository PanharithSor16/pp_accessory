  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-96">
        <h2 className="text-lg font-semibold mb-4">Add Accessory </h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-sm font-medium mb-2" htmlFor='code'>Accessary Code</label>
            <input
              id='code'
              type="text"
              required
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-2" htmlFor='name'>Accessay Name</label>
            <input
              id='name'
              type="text"
              required
